...
const Project3 = () => {
    return(
        <Card className="group hover:shadow-lg transition-all duration-300 dark:hover:bg-gray-900 hover:bg-gray-100">
              <div className="relative aspect-video rounded-t-lg overflow-hidden">
                <Image src="/pictures/shell.png" alt={""} fill className="object-cover"/>
              </div>
              <CardContent className="p-6">
                <h3 className="font-semibold text-lg mb-2">Shell</h3>
                <p className="text-muted-foreground text-sm mb-4">
                  A custom shell program, designed to mimic shell operations in Unix/Linux systems supporting essential features like built-in commands, external command execution, piping, redirection, autocomplete, environment variable handling and history persistence.
                </p>
                <div className="flex flex-wrap gap-1 mb-4">
                  <Badge variant="secondary" className="text-xs">
                    Rust
                ...
                <div className="flex gap-2">
                  <Button asChild variant="outline" size="sm">
                    <a href="https://github.com/04Nightmare/MyShell" target="_blank" rel="noopener noreferrer">
                      <Github/>
                      Code
                    </a>
                  </Button>
